...
const OilCannonDefine: CannonDefine = {
    levelDefine: [{ damage: 30, attackSpeed: 500, attackRange: 500, upgrade: {
        golds: 10,
    } }],
    name: "Oil Barrel",
    texture: { name: "cannon_barrel_img", frame: "cannon_oil_barrel_1" },
    shotAnim: "oil_barrel_shot",
    price: 1,
};

export class OilCannonBarrel extends CannonBarrel {
    constructor(scene: Phaser.Scene, parent: CannonBase) {
        super(scene, parent, OilCannonDefine);
