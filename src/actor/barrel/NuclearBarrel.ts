...
const NuclearCannonDefine: CannonDefine = {
    levelDefine: [{ damage: 30, attackSpeed: 500, attackRange: 500, upgrade: {
        golds: 10,
    } }],
    name: "Nuclear Barrel",
    texture: { name: "cannon_barrel_img", frame: "cannon_nuclear_barrel_1" },
    shotAnim: "nuclear_barrel_shot",
    price: 1,
};

export class NuclearCannonBarrel extends CannonBarrel {
    constructor(scene: Phaser.Scene, parent: CannonBase) {
        super(scene, parent, NuclearCannonDefine);
